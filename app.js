...
import PaymentModal from "./payment.js?v=20260625-ludo-firebase1";
import { ensureXchangeState, getXchangeState } from "./xchange.js?v=20260625-ludo-firebase1";
import {
...
import { mountRetraitModal } from "./retrait.js?v=20260625-ludo-firebase1";
          ...
          <button type="button" class="group w-full rounded-[28px] border border-[#dfe7e1] bg-white px-5 py-5 text-left transition duration-150 hover:border-[#cae5d5] hover:bg-[#f8fcf9]" data-domino-duel-select-mode="friend">
            <div class="flex items-start gap-4">
              <div class="min-w-0 flex-1">
                <p class="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#7b8a83]">Aktif</p>
...
function openFairplayInfoModal() {
  return new Promise((resolve) => {
    const modal = document.createElement("section");
    modal.className = "kobposh-fairplay-info-modal is-open";
    modal.setAttribute("aria-hidden", "false");
    modal.innerHTML = `
