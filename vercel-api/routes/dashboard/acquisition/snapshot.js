...
const { computeClientAcquisitionSnapshot } = require("../../../lib/dashboard-analytics");
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const normalized = normalizeError(error, "Impossible de charger le snapshot acquisition.");
