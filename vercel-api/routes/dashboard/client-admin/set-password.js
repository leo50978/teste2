...
const { adminSetClientPassword } = require("../../../lib/dashboard-client-admin");
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const result = await adminSetClientPassword({
    ...
    const normalized = normalizeError(error, "Impossible de reinitialiser le mot de passe du client.");
